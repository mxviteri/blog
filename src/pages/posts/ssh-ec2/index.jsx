        ...
        <div className="ssh-ec2">
          <div className="container">
            ...
            <div className="post">
              ...
              <div className="links">
                <h3>Links to amazon docs:</h3>
                <ul>
                  <li><a href="https://docs.aws.amazon.com/elasticbeanstalk/latest/dg/eb-cli3-install-linux.html" target="_blank">https://docs.aws.amazon.com/elasticbeanstalk/latest/dg/eb-cli3-install-linux.html</a></li>
                  <li><a href="https://docs.aws.amazon.com/elasticbeanstalk/latest/dg/eb-cli3-configuration.html" target="_blank">https://docs.aws.amazon.com/elasticbeanstalk/latest/dg/eb-cli3-configuration.html</a></li>
                  <li><a href="https://docs.aws.amazon.com/elasticbeanstalk/latest/dg/eb-cli3-getting-started.html" target="_blank">https://docs.aws.amazon.com/elasticbeanstalk/latest/dg/eb-cli3-getting-started.html</a></li>
                  <li><a href="https://docs.aws.amazon.com/elasticbeanstalk/latest/dg/eb3-ssh.html" target="_blank">https://docs.aws.amazon.com/elasticbeanstalk/latest/dg/eb3-ssh.html</a></li>
                </ul>
              </div>
            </div>
          </div>
